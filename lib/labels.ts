export const STATUS_LABELS: Record<string, string> = {
  PENDING_1: "รอผู้อนุมัติลำดับที่ 1 (ทีม HR เครือข่ายฯ)",
  PENDING_2: "รอผู้อนุมัติลำดับที่ 2 (ผู้บริหารทีมสนับสนุนฯ)",
  PENDING_3: "รอผู้อนุมัติลำดับที่ 3 (ผู้บริหารทีม RTI)",
